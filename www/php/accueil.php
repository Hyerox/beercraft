    ...
    <div class="absolute top-0 right-0 mt-4 mr-4 text-white">
        <?php if (!isset($_SESSION['user_id'])): ?>
            <nav class="flex gap-2">
                <li class="bg-gray-700 list-none py-2 px-4 rounded-xl"><a href="login.php">Se connecter</a></li>
                <li class="bg-gray-700 list-none py-2 px-4 rounded-xl"><a href="signup.php">S'inscrire</a></li>
            </nav>
        <?php else: ?>
            <li class="bg-gray-700 list-none py-2 px-4 rounded-xl hover:bg-gray-800"><a href="logout.php">Se déconnecter</a></li>
        <?php endif; ?>
    </div>
